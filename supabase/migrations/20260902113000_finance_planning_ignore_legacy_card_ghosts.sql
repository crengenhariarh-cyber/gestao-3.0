...
comment on view public.finance_planning_items is 'Pending financial installments and card statements. Legacy card cycles without a formal statement are not treated as overdue payables after their due date.';
