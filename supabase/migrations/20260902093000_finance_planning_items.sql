...
comment on view public.finance_planning_items is 'Pending financial installments and card statements, including open card cycles with derived due dates, for daily summary and payment planning.';
