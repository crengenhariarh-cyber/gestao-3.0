...
begin
  ...
  if p_cost_center_id is not null and not exists (
    ...
    where c.tenant_id = p_tenant_id and c.company_id = p_company_id
      and c.id = p_cost_center_id and c.status = 'active'
