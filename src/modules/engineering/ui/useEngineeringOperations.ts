...
export function useEngineeringOperations(scope: EngineeringScope) {
  ...
  return {
    ...
    updateProvisionalLine:(input:Parameters<typeof repository.updateProvisionalLine>[1])=>execute(()=>repository.updateProvisionalLine(scope,input),'Item do provisório atualizado.'),
