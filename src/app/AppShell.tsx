...
export function AppShell({ session }: AppShellProps) {
  ...
  const activeMobileItem = location.pathname === '/' ? 'Início' : location.pathname === '/bancos' ? 'Bancos' : location.pathname === '/financeiro' && searchParams.get('tab') === 'cartoes' ? 'Cartões' : location.pathname === '/financeiro' && searchParams.get('action') === 'new-entry' ? 'Adicionar' : null;
