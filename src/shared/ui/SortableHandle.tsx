...
export function SortableHandle({ itemId, tenantId, group, label = 'Arrastar para reorganizar', onReorder }: SortableHandleProps) {
  ...
  function highlightTarget(clientX: number, clientY: number) {
