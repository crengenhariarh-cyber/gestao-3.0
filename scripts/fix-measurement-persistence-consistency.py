...
# Historical originRows implementation. Newer source may already use
# activeMeasurementId; in that case we validate instead of requiring the old text.
...
# Historical save verification implementation. Newer source may use
# targetMeasurementId as the authoritative id; do not fail on that evolution.
...
# Validate behavior rather than obsolete textual anchors.
required = [
...
print('Measurement persistence consistency guard verified.')
